...
class incidencias extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $incidencia->icd_Priority = $data[10]['value'];
        $incidencia->icd_reportedBy = $data[11]['value'];
        $incidencia->icd_Shift = $data[12]['value'];
        $incidencia->icd_ReportingDate = $data[13]['value'];
        $incidencia->icd_ClosingDate = $data[14]['value'];
        $incidencia->icd_ResponseTime = $data[15]['value'];
        $incidencia->icd_StartTime = $data[16]['value'];
        $incidencia->icd_EndTime = $data[17]['value'];
        $incidencia->icd_TotalTime = $data[18]['value'];
        $incidencia->icd_DiagramaProcManual = $data[19]['value'];
        $incidencia->icd_Respaldo = $data[20]['value'];
        $incidencia->icd_Refaccion = $data[21]['value'];
        $incidencia->icd_tiempoDiagnosticar = $data[22]['value'];
        $incidencia->icd_Estatus = $data[23]['value'];
        $incidencia->icd_ProblemDescription = $data[24]['value'];
        $incidencia->icd_Comments = $data[25]['value'];
