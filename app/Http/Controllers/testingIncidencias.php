...
class testingIncidencias extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        $incidencia->icd_reportedBy =  $request['data'][21]['value'];
        $incidencia->icd_tiempoDiagnosticar =  $request['data'][22]['value'];
    ...
    public function getElements(){
        ...
        ->where('ctg_padre', '=', $_GET['parent'] == 'null' ? null : $_GET['parent'])
        ->get();
